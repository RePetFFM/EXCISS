...
void setup() {
    ...
    Serial3.println("serial scu rdy");
...
void MCU__init_pins() {
    ...
    digitalWrite( DOUT_USB_X_PWR , LOW );

    pinMode( DOUT_USB_A_PWR , OUTPUT );
    digitalWrite( DOUT_USB_A_PWR , LOW );

    pinMode( DOUT_USB_B_PWR , OUTPUT );
    digitalWrite( DOUT_USB_B_PWR , LOW );

    pinMode( DOUT_USB_X_TOGGLE , OUTPUT);


    pinMode( DOUT_USBHUB_PWR , OUTPUT );
    digitalWrite( DOUT_USBHUB_PWR , LOW );
