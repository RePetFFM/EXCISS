...
public:
	...
	uint16_t adcVBUS = 0xFFFF;

	uint16_t adcPSYS = 0xFFFF;

	uint16_t adcIBATCharge = 0xFFFF;

	uint16_t adcIBATDischarge = 0xFFFF;

	uint16_t adcIIN = 0xFFFF;

	uint16_t adcCMPIN = 0xFFFF;

	uint16_t adcVSYS = 0xFFFF;

	uint16_t adcVBAT = 0xFFFF;
