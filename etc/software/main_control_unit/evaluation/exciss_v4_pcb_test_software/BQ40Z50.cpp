...
BQ40Z50::BQ40Z50 (uint8_t address) {
...
void BQ40Z50::updateValues() {
	...
	batteryChemID = readWordManufacturer(BQ40Z50_DEFAULT_ADDR, BQ40Z50_MAC, 0x0006);
	...
	temperature = busMaster.readWordLSB(BQ40Z50_DEFAULT_ADDR, BQ40Z50_TEMPERATURE); // 0.1 kelvin steps
...
uint16_t BQ40Z50::readWordManufacturer(uint8_t aI2CDeviceAddress, uint8_t aFunction, uint16_t aManufacturerFunction) {
	...
	*/
	...
	busMaster.writeWordLSB(aI2CDeviceAddress,aFunction,aManufacturerFunction);
