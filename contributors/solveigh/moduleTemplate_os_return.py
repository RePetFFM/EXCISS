...
log_fileHandler = logging.FileHandler('/home/pi/log/moduleTemplate_os_return.log')
...
def runOperation():
  whereAmI = os.popen('pwd').read()
  x = os.popen('ls -l').read()
  print "Content of: " + str(whereAmI)
  print str(x)
